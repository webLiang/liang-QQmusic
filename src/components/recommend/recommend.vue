    ...
    <scroll ref="scroll"  class="recommend-content" :data="discList">
        ...
        <div class="slider-wrapper">
          <slider v-if="recommends.length">
            <div  v-for="item in recommends" class="slider-wrapper" ref="sliderWrapper">
              <a :href="item.linkUrl">
                <img class="needsclick" @load="loadImage" :src="item.picUrl" alt="hehe">
              </a>
            </div>
          </slider>
        </div>
        ...
        <div v-if="recommends.length" class="slider-wrapper" ref="sliderWrapper">
          <slider>
            <div v-for="item in recommends">
              <a :href="item.linkUrl">
                <img ageclass="needsclick" @load="loadIm" :src="item.picUrl">
              </a>
            </div>
          </slider>
        </div>
